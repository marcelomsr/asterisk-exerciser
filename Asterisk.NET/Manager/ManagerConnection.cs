...
namespace Asterisk.NET.Manager
{
    ...
    public class ManagerConnection
	{
        ...
        public ManagerConnection()
		{
            ...
            Helper.RegisterEventHandler(registeredEventHandlers, 16, typeof(DialEndEvent));
            ...
            Helper.RegisterEventHandler(registeredEventHandlers, 63, typeof(VarSetEvent));
		...
		protected internal AsteriskVersion determineVersion()
		{
			...
			Response.ManagerResponse showVersionFilesResponse = SendAction(new Action.CommandAction("core show version files"), defaultResponseTimeout * 2);
